...
def get_data(filters = None):
	...
	sgst_details = frappe.db.get_all('SGST Detail', {'parent': 'Singapore GST Settings', 'company':filters.company}, ['box_1', 'box_2', 'box_3', 'bank_interest_income', 'realised_exchange_gainloss'])
